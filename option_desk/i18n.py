...
UI = {
    "en": {
        ...
        "regime_back": "VIX term backwardation",
        "regime_contango": "VIX term contango",
        "regime_spy_below_50": "SPY below 50DMA",
        "regime_spy_above_50": "SPY above 50DMA",
        "regime_qqq_below_20": "QQQ below 20DMA",
        "regime_qqq_above_20": "QQQ above 20DMA",
        "pipe_regime_started": "Reading VIX / SPY / QQQ market regime…",
        "pipe_regime_done": "Market {label}: {why}",
        "regime_label_on": "risk-on",
        "regime_label_neutral": "neutral",
        "regime_label_caution": "caution",
        "regime_label_off": "risk-off",
        "pipe_regime_failed": "Market regime unavailable: {exc}",
        "pipe_regime_none": "Market regime unavailable; desk continues without it",
        "md_market": "Market regime",
        "md_iv": "IV vs HV",
        "md_em": "Expected move",
        "md_score": "score",
        "md_inside_em": "inside EM",
        "md_outside_em": "outside EM",
        "score": "Score",
        "market": "Market",
        "iv_vs_hv": "IV vs HV",
    ...
    "zh": {
        ...
        "regime_back": "VIX 期限倒挂",
        "regime_contango": "VIX 期限升水",
        "regime_spy_below_50": "SPY 低于 50 日均",
        "regime_spy_above_50": "SPY 高于 50 日均",
        "regime_qqq_below_20": "QQQ 低于 20 日均",
        "regime_qqq_above_20": "QQQ 高于 20 日均",
        "pipe_regime_started": "正在读取 VIX / SPY / QQQ 市场体制…",
        "pipe_regime_done": "市场体制 {label}：{why}",
        "regime_label_on": "Risk-On",
        "regime_label_neutral": "中性",
        "regime_label_caution": "谨慎",
        "regime_label_off": "Risk-Off",
        "pipe_regime_failed": "市场体制不可用：{exc}",
        "pipe_regime_none": "市场体制不可用，终审不依赖这一层",
        "md_market": "市场体制",
        "md_iv": "IV vs 已实现波动",
        "md_em": "预期波动",
        "md_score": "评分",
        "md_inside_em": "在预期波动内",
        "md_outside_em": "在预期波动外",
        "score": "评分",
        "market": "市场",
        "iv_vs_hv": "IV vs HV",
        "expected_move": "预期波动",
