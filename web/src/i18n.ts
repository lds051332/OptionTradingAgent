...
const zh = {
  ...
  home: {
    ...
    replayAction: "看三条约束回放",
    replayBody: "不拉行情、不调模型。硬门控、伪造合约、降风险各走一遍现行规则。",
  },
  app: {
    ...
    titleReplay: "约束回放 · 摩根大山",
  },
  replay: {
    title: "约束回放",
    lead: "左边是录好的模型原文，右边是现行规则盖章。回放不请求行情，也不调用模型。",
    loading: "正在准备回放…",
    loadFailed: "回放没有打开",
    play: "播放",
    model: "模型原文",
  ...
  desk: {
    ...
    callEarlier: "先前这种方式没解析成功，已改用上面那次：{detail}",
    callMeta: "{method} · {ms} ms · {tokens}",
    callMetaBare: "{method} · {ms} ms",
    callUsage: "{n} token",
    callEstimate: "约 {n} token",
    rewriteNone: "未改写",
    rewriteKicker: "强制器",
    queries: "查询",
    stepError: "中断",
...
const en: NestedStrings<typeof zh> = {
  ...
  home: {
    ...
    positionsOptional: "Optional",
    replayAction: "Play three rule replays",
    replayBody: "No live quotes and no model call. Hard gate, invented contract, and reduce-risk each run through the current rules.",
  },
  app: {
    titleHome: "摩根大山 · Option Desk",
    ...
    titleReplay: "Rule replays · 摩根大山",
  },
  replay: {
    title: "Rule replays",
    lead: "The left slip is a recorded model proposal. The right slip is the live rule stamp. Replays do not fetch quotes or call a model.",
    loading: "Preparing replays…",
    loadFailed: "Could not open the replay",
    play: "Play",
    model: "Model",
    ruled: "Rules",
    rewrite: "Rule rewrite",
    arrow: "Rewritten",
    changed: "Fields rewritten",
    fieldAction: "Action",
    ...
    again: "Play again",
    working: "Replaying",
    recorded: "Recorded proposal",
    payoff: "Expiration payoff of the stamped decision",
    empty: "—",
  },
  desk: {
    putTitle: "Put desk",
    ...
    stepDesk: "Desk",
    callHeuristic: "heuristic",
    callEarlier: "An earlier method did not parse; the line above is the one that worked. {detail}",
    callMeta: "{method} · {ms} ms · {tokens}",
    callMetaBare: "{method} · {ms} ms",
    callUsage: "{n} tok",
    callEstimate: "~{n} tok",
    rewriteNone: "Unchanged",
    rewriteKicker: "Enforcer",
    queries: "Queries",
